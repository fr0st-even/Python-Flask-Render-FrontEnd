class UserProfile extends HTMLElement {
    ...
    async loadUserProfile() {
        try {
            ...
            const userResponse = await fetch(`https://python-flask-render-136u.onrender.com/api/users`);
            ...
            const imagesResponse = await fetch(`https://python-flask-render-136u.onrender.com/api/images`);
